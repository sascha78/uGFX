...
// Include all the drivers valid values into the VMT
	...
	#elif !GDISP_HARDWARE_VMT_DEINIT
		#undef GDISP_HARDWARE_VMT_DEINIT
		#define GDISP_HARDWARE_VMT_DEINIT	GFXSOME
	#endif
#elif GDISP_HARDWARE_VMT_DEINIT == GFXON
	#undef GDISP_HARDWARE_VMT_DEINIT
	#define GDISP_HARDWARE_VMT_DEINIT		GFXSOME
#endif
	...
	#elif !GDISP_HARDWARE_VMT_FLUSH
		#undef GDISP_HARDWARE_VMT_FLUSH
		#define GDISP_HARDWARE_VMT_FLUSH	GFXSOME
	#endif
#elif GDISP_HARDWARE_VMT_FLUSH == GFXON
	#undef GDISP_HARDWARE_VMT_FLUSH
	#define GDISP_HARDWARE_VMT_FLUSH		GFXSOME
#endif
	...
	#elif !GDISP_HARDWARE_VMT_READ
		#undef GDISP_HARDWARE_VMT_READ
		#define GDISP_HARDWARE_VMT_READ		GFXSOME
	#endif
#elif GDISP_HARDWARE_VMT_READ == GFXON
	#undef GDISP_HARDWARE_VMT_READ
	#define GDISP_HARDWARE_VMT_READ			GFXSOME
#endif
	...
	#elif !GDISP_HARDWARE_VMT_SETPOS
		#undef GDISP_HARDWARE_VMT_SETPOS
		#define GDISP_HARDWARE_VMT_SETPOS	GFXSOME
	#endif
#elif GDISP_HARDWARE_VMT_SETPOS == GFXON
	#undef GDISP_HARDWARE_VMT_SETPOS
	#define GDISP_HARDWARE_VMT_SETPOS		GFXSOME
#endif
	...
	#elif !GDISP_HARDWARE_VMT_MOVE
		#undef GDISP_HARDWARE_VMT_MOVE
		#define GDISP_HARDWARE_VMT_MOVE		GFXSOME
	#endif
#elif GDISP_HARDWARE_VMT_MOVE == GFXON
	#undef GDISP_HARDWARE_VMT_MOVE
	#define GDISP_HARDWARE_VMT_MOVE			GFXSOME
#endif
	...
	#elif !GDISP_HARDWARE_VMT_IOCTL
		#undef GDISP_HARDWARE_VMT_IOCTL
		#define GDISP_HARDWARE_VMT_IOCTL	GFXSOME
	#endif
#elif GDISP_HARDWARE_VMT_IOCTL == GFXON
	#undef GDISP_HARDWARE_VMT_IOCTL
	#define GDISP_HARDWARE_VMT_IOCTL		GFXSOME
#endif
