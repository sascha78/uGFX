...
#define CALIBRATION_BACKGROUND			GFXBLUE

#define CALIBRATION_CROSS_COLOR1		GFXWHITE
...
#define CALIBRATION_TITLE_COLOR			GFXWHITE
#define CALIBRATION_TITLE_BACKGROUND	GFXBLUE

#define CALIBRATION_ERROR_TEXT			"Calibration Failed!"
#define CALIBRATION_ERROR_DELAY			3000
#define CALIBRATION_ERROR_COLOR			GFXRED
#define CALIBRATION_ERROR_BACKGROUND	GFXYELLOW
